...
function PlayListModal() {
    ...
    const createPlayListHandler = () => {
        playListTitle && createPlayList(dispatchUserData , token ,playListTitle)
        setPlayListTitle("")
    }
    const videoToPlayListHandler = (e , playlist) => {
        if(e.target.checked){
            addToPlayList(dispatchUserData , token , playlist , modalVideo)
        }else{
            removeFromPlayList(dispatchUserData , token ,playlist , modalVideo)
        }
    }
  return (
      <>
                            ...
                            playlists.length > 0 &&  playlists.map(playlist => {
                                 ...
                                 <label key={playlist._id} className="modal-label">
                                    ...
                                    <input 
                                        ...
                                        checked={inPlayList}
                                        type="checkbox" name="category-checkbox" id={playlist._id} />
                                    {playlist.title}
                                 </label>
                    ...
                    </div>
                    {
                        ...
                        <><div class="modal-title">PlayList Title</div>
                            <input 
                                ...
                                className= "modal-input" type="text" placeholder="enter playlist title" />
                         ...
                         <div class="buttons-div">
                            ...
                            class="btn">Create New PlayList</button>
                         </div>
                    }
